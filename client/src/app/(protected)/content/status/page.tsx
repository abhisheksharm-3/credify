...
<div className="container mx-auto p-4 space-y-6">
        <header className="flex flex-col md:flex-row justify-between items-center bg-card p-6 rounded-lg shadow-sm">
          <h1 className="text-3xl font-bold text-foreground mb-4 md:mb-0">Verification Status</h1>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center bg-card p-6 rounded-lg shadow-sm space-y-4 md:space-y-0">
