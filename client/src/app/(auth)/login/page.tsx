...
const Login = () => {
  ...
  return (
    <Layout className="min-h-screen gap-4  flex justify-center items-center">
      <div className="flex w-full border-b-2">
        <div className="w-full hidden md:flex border-r-2 ">
          <SignUPLoginInCard />
        </div>
        <div className="w-full flex items-center justify-center">
          <Card className="w-[350px] my-14 *:     dark:bg-gray-400 dark:rounded-md dark:bg-clip-padding dark:backdrop-filter dark:backdrop-blur-sm dark:bg-opacity-10">
            <CardHeader>
