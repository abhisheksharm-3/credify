...
const Login: React.FC = () => {
  ...
  return (
    <Layout>
      <div className="min-h-screen flex flex-col md:flex-row border-b">
        <Particles
        ...
        <div className="w-full z-30 md:w-1/2 bg-gradient-to-br from-primary to-secondary p-12 flex flex-col justify-center items-center text-white">
          <h1 className="text-4xl font-bold mb-6">Credify</h1>
          <p className="text-xl mb-8 text-center">Safeguarding Digital Truth</p>
            ...
            <div className="mt-6">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-background text-gray-500">Or login with</span>
                </div>
              </div>
